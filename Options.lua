...
local function buildLeftColumn()
    ...
    unitFramesCheckbox:HookScript("OnClick", function(_, btn, down)
        ...
        PlayerFrame:SetPoint(SafeUnpack(PlayerFrame.defaultPos))
        TargetFrame:ClearAllPoints()
        TargetFrame:SetPoint(SafeUnpack(TargetFrame.defaultPos))
    ...
    minimapCheckbox:HookScript("OnClick", function(_, btn, down)
        ...
        MinimapCluster:SetPoint(SafeUnpack(MinimapCluster.defaultPos))
        MinimapZoneTextButton:ClearAllPoints()
        MinimapZoneTextButton:SetPoint(SafeUnpack(MinimapZoneTextButton.defaultPos))
        MinimapToggleButton:ClearAllPoints()
        MinimapToggleButton:SetPoint(SafeUnpack(MinimapToggleButton.defaultPos))
        MinimapBorderTop:ClearAllPoints()
        MinimapBorderTop:SetPoint(SafeUnpack(MinimapBorderTop.defaultPos))
        TimeManagerClockButton:ClearAllPoints()
        TimeManagerClockButton:SetPoint(SafeUnpack(TimeManagerClockButton.defaultPos))
        BuffFrame:ClearAllPoints()
        BuffFrame:SetPoint(SafeUnpack(BuffFrame.defaultPos))
